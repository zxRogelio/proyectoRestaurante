  ...
  <div class="container my-4">
    <div class="row">
      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#" ><img src="<?php echo APP_URL; ?>app/views/img/R1.png" alt="Restaurante1" class="img-fluid"></a>
      </div>
      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#" ><img src="<?php echo APP_URL; ?>app/views/img/R2.png" alt="Restaurante2" class="img-fluid"></a>
      </div>
      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#" ><img src="<?php echo APP_URL; ?>app/views/img/R3.png" alt="Restaurante3" class="img-fluid"></a>
      </div>
      <div class="col-md-3 col-sm-6 mb-4">
        <a href="#" ><img src="<?php echo APP_URL; ?>app/views/img/R4.png" alt="Restaurante4" class="img-fluid"></a>
      </div>
    </div>
  </div>
